...
# Created by `pipx` on 2023-09-29 09:26:14
export PATH="$PATH:/home/sabad/.local/bin"
...
alias hdir='cd $HADOOP_HOME'
alias repo='cd /mnt/e/repos/BigData/'
alias api='cd /mnt/e/repos/Python/APIs_and_Microservices/'
